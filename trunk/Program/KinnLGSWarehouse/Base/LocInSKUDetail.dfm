object frmLocInSKUDetail: TfrmLocInSKUDetail
  Left = 199
  Top = 161
  ...
  object grdSKUDetail: TdxDBGrid
    ...
    object piece: TdxDBGridCurrencyColumn
      Alignment = taCenter
      Caption = #20214#25968
      HeaderAlignment = taCenter
      Width = 47
      BandIndex = 0
      RowIndex = 0
      OnValidate = pieceValidate
      FieldName = 'piece'
      DisplayFormat = '0.####;-,0.####'
      Nullable = False
    end
    object volume: TdxDBGridCurrencyColumn
      Alignment = taCenter
      Caption = #20307#31215
      HeaderAlignment = taCenter
      Width = 47
    ...
    object quantityremain: TdxDBGridCurrencyColumn
  ...
  object KGroupBox1: TKGroupBox
    ...
    object ckbPiece: TdxCheckEdit
      ...
      Style.BorderStyle = xbsNone
      TabOrder = 0
      Caption = #32479#35745#31665#25968#21040#20179#20301#20449#24687
      StyleController = frmMain.StyleCheck
      State = cbsChecked
    end
  end
