...
type
  ...
  TfrmCheckSKUDetail = class(TForm)
...
function workCheckSKUDetail(strtype:string,pstrjobno:string);

var
  frmCheckSKUDetail: TfrmCheckSKUDetail;
...
procedure TfrmCheckSKUDetail.CreateParams(var Params: TCreateParams);
begin
...
procedure TfrmCheckSKUDetail.WorkCall(CallMode:TDataState);
{模块调用入口
   CallMode:调用状态
       stBrowse:浏览查看
       stInsert:新增
...
procedure TfrmCheckSKUDetail.EnableEdit;
begin
...
procedure TfrmCheckSKUDetail.DisableEdit;
{查看数据状态，需DISABLE的动作}
begin
...
procedure TfrmCheckSKUDetail.FormCreate(Sender: TObject);
begin
...
procedure TfrmCheckSKUDetail.FormClose(Sender: TObject;
...
procedure TfrmCheckSKUDetail.FormDestroy(Sender: TObject);
var
...
procedure TfrmCheckSKUDetail.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmCheckSKUDetail.grdSKUDetailChangeNodeEx(Sender: TObject);
begin
...
procedure TfrmCheckSKUDetail.grdSKUDetailEditing(Sender: TObject;
...
procedure TfrmCheckSKUDetail.grdSKUDetailEnter(Sender: TObject);
begin
...
procedure TfrmCheckSKUDetail.grdSKUDetailExit(Sender: TObject);
begin
...
procedure TfrmCheckSKUDetail.grdSKUDetailKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   with TdxDBGrid(Sender) do
   begin
...
procedure TfrmCheckSKUDetail.grdSKUDetailBeforeInsert;
begin
...
procedure TfrmCheckSKUDetail.mitSkuAddClick(Sender: TObject);
begin
...
procedure TfrmCheckSKUDetail.mitSkuDelClick(Sender: TObject);
begin
...
procedure TfrmCheckSKUDetail.qryskudetailBeforePost(DataSet: TDataSet);
begin
...
procedure TfrmCheckSKUDetail.btnOkClick(Sender: TObject);
begin
   frmLIOSKUDetail.close;
end;

procedure TfrmCheckSKUDetail.KBitBtn5Click(Sender: TObject);
begin
   WorkCall(stBrowse);
   close;
end;

procedure TfrmCheckSKUDetail.btnSaveCloseClick(Sender: TObject);
begin
   if (DataState in Setdcs) then
   begin
...
procedure TfrmCheckSKUDetail.btnEditClick(Sender: TObject);
begin
   WorkCall(stEdit);
end;

procedure TfrmCheckSKUDetail.edtSKUSKUNameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
var
   pt:TPoint;
   rect:TRect;
...
procedure TfrmCheckSKUDetail.edtqualitynameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
   if DataState in setDcs then
   begin
...
procedure TfrmCheckSKUDetail.mitSkuClick(Sender: TObject);
var
   i:integer;
...
procedure TfrmCheckSKUDetail.mitOrderClick(Sender: TObject);
var
   TSKUDetailSelect:TMultSkuDetailSelect;
   I:Integer;
begin
...
procedure TfrmCheckSKUDetail.edtdepthValidate(Sender: TObject;
  var ErrorText: String; var Accept: Boolean);
begin
...
function TfrmCheckSKUDetail.GetScale(pstrUomVolume,pstrUomSize:String):Extended;
begin
...
procedure TfrmCheckSKUDetail.edtwidthValidate(Sender: TObject;
  var ErrorText: String; var Accept: Boolean);
begin
   if (DataState in Setdcs) and (grdSKUDetail.InplaceEditor.GetEditingText<>'') then
   begin
...
procedure TfrmCheckSKUDetail.edtheightValidate(Sender: TObject;
  var ErrorText: String; var Accept: Boolean);
begin
   if (DataState in Setdcs) and (grdSKUDetail.InplaceEditor.GetEditingText<>'') then
   begin
...
procedure TfrmCheckSKUDetail.edtPieceValidate(Sender: TObject;
  var ErrorText: String; var Accept: Boolean);
var
   expiece:Extended;
begin
...
procedure TfrmCheckSKUDetail.cmbVolumeUOMValidate(Sender: TObject;
  var ErrorText: String; var Accept: Boolean);
var
...
procedure TfrmCheckSKUDetail.sizeuomValidate(Sender: TObject;
  var ErrorText: String; var Accept: Boolean);
var
...
procedure TfrmCheckSKUDetail.quantity_piece_propValidate(Sender: TObject;
  var ErrorText: String; var Accept: Boolean);
begin
   if (DataState in Setdcs) then
   begin
...
procedure TfrmCheckSKUDetail.FormActivate(Sender: TObject);
begin
   if DataState=stbrowse then
   begin
...
procedure TfrmCheckSKUDetail.mitcopyClick(Sender: TObject);
begin
...
procedure TfrmCheckSKUDetail.mitplasteClick(Sender: TObject);
begin
...
procedure TfrmCheckSKUDetail.mitColumnsetClick(Sender: TObject);
begin
   WorkSetGrid(grdSKUDetail,frmLIOSKUDetail.Name);
end;

procedure TfrmCheckSKUDetail.edtSerialNOScanExit(Sender: TObject);
var
...
procedure TfrmCheckSKUDetail.edtPathButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
...
procedure TfrmCheckSKUDetail.KBitBtn1Click(Sender: TObject);
var
   strname:string;
begin
...
// lzw 2008.01.11
procedure TfrmCheckSKUDetail.mitskudetailClick(Sender: TObject);
var
   i:integer;
